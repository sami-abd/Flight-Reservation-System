...
app.post("/api/v1/user/removeFlight/", (req, res) => {
    try {
        ...
        db.query(query, [flightID], (error, results) => {
            ...
            // Handle for when no results are returned
            if (error) {
                res.status(404).json({ message: 'The flight was NOT successfully removed', data: '0' })
            }
...
app.post("/api/v1/user/removeAircraft/", (req, res) => {
    try {
        ...
        db.query(query, [aircraftID], (error, results) => {
            ...
            // Handle for when no results are returned
            if (error) {
                res.status(404).json({ message: 'The aircraft was NOT successfully removed', data: '0' })
            }
...
app.post("/api/v1/user/assignCrew/", (req, res) => {
    try {
        ...
        db.query(query1, [flightAttendantID, flightID], (error, results) => {
            ...
            if (error) {
                res.status(404).json({
                    message: "The crew was NOT successfully assigned to the specified flight",
                    data: "0",
                });
            }
            ...
            // Handle for when 1 or more results are returned:
                ...
                res
                    ...
                    .json({
                        success: true,
                        message: "The crew has been successfully assigned to the specified flight",
                        data: results,
                    });
            }
        });
...
app.post("/api/v1/user/removeCrew/", (req, res) => {
    try {
        ...
        db.query(query, [flightAttendantID, flightID], (error, results) => {
            ...
            // Handle for when no results are returned
            if (error) {
                res.status(404).json({ message: 'The crew member was NOT successfully removed', data: '0' })
            }
